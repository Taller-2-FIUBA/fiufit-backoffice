    ...
    <Card className="user-profile">
      <CardContent>
        ...
        <Box className="user-details" sx={{ flexGrow: 1, overflow: 'hidden'}}>
          ...
          <ProfileItem title="Registration Date" value={user?.registration_date} icon="CalendarToday"/>
          <ProfileItem title="Birth Date" value={user?.birth_date} icon="Cake"/>
          <ProfileItem title="Location" value={user?.location} icon="LocationOn"/>
